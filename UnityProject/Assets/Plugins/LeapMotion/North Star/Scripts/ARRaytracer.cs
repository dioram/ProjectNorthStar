    ...
    public class ARRaytracer : MonoBehaviour, IRuntimeGizmoComponent
    {
                                                  ...
                                                  bool printDebug = false)
        {
            ...
            Vector3 sphereSpaceRayDirection =
                optics.worldToSphereSpace.MultiplyPoint(optics.eyePosition + inputUV) - sphereSpaceRayOrigin;
        ...
        {
            Vector3 dir = clipToWorld.MultiplyPoint(new Vector3(UV.x - 0.5f, UV.y - 0.5f, 0.5f) * 2f);
            dir -= cameraPosition;
