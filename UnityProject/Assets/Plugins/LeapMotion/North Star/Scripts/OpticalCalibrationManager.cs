...
namespace Leap.Unity.AR
{
    ...
    public class OpticalCalibrationManager : MonoBehaviour
    {
        ...
        readonly Vector4 DEFAULT_PROJECTION_PARAMS = new Vector4(-0.699999988079071f, 0.699999988079071f, 0.30000001192092898f, -1.4299999475479127f);
        Vector4 rightEyeProjectionParams = new Vector4(-0.699999988079071f, 0.699999988079071f, 0.30000001192092898f, -1.4299999475479127f);
        Vector4 leftEyeProjectionParams = new Vector4(-0.699999988079071f, 0.699999988079071f, 0.30000001192092898f, -1.4299999475479127f);
